 ...
 */
public class BodyConsumptionFragment extends Fragment implements View.OnClickListener, View.OnFocusChangeListener {
   ...
   /* ImageButton btnback;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_body_consumption, container, false);
        findViews(rootView);
        return rootView;
    }

    public void findViews(View rootView) {
        btnback = (ImageButton) rootView.findViewById(R.id.back_body);
    ...
    public void onClick(View view) {
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.fragment_container, new YourProfileFragment(), "YourProfileFragment");
                fragmentTransaction.addToBackStack("YourProfileFragment");
...
*/
    ...
    private TextView titleBodyComposition;
    ...
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_body_consumption, container, false);
        context = getContext();
        mCurrentAcitivty = getActivity();
   ...
   /* @Override
    ...
    private void init(View rootView) {
        ...
        titleBodyComposition = (TextView) rootView.findViewById(R.id.title_body_consumption);
        MyApplication.setContext(getActivity());
        titleBodyComposition.setTypeface(MyApplication.getFont());

        units_edit = (EditText) rootView.findViewById(R.id.edit_units);
        ...
        mUnitsWheel = (WheelView) rootView.findViewById(R.id.units_wheel);
        ...
        mUpdatebtn = (Button) rootView.findViewById(R.id.next_btn);
        ...
        mWeightLayout = (LinearLayout) rootView.findViewById(R.id.weight_layout);
        mHeightLayout = (LinearLayout) rootView.findViewById(R.id.height_layout);
        ...
        mPicker_Title = (TextView) rootView.findViewById(R.id.picker_title);

        mPicker_Close.setOnClickListener(this);
        mPicker_Select.setOnClickListener(this);

        age_edit = (EditText) rootView.findViewById(R.id.edit_age);
        age_edit.setKeyListener(null);
        age_edit.setOnFocusChangeListener(this);
        age_edit.setOnClickListener(this);

        mAgeWheel = (WheelView) rootView.findViewById(R.id.age_wheel);
        mAgeAdapter = new NumericWheelAdapter(getContext(), AGE_MIN, AGE_MAX);
        ...
        weight_edit = (EditText) rootView.findViewById(R.id.edit_weight);
        weight_edit.setKeyListener(null);
        weight_edit.setOnFocusChangeListener(this);
        weight_edit.setOnClickListener(this);

        mWeightWheel = (WheelView) rootView.findViewById(R.id.weight_wheel);
        mWeightAdapter = new NumericWheelAdapter(getContext(), WEIGHT_MIN_METRIC, WEIGHT_MAX_METRIC);
        ...
        mWeightUnitWheel = (WheelView) rootView.findViewById(R.id.weight_unit_wheel);
        ...
        height_edit = (EditText) rootView.findViewById(R.id.edit_height);
        height_edit.setKeyListener(null);
        height_edit.setOnFocusChangeListener(this);
        height_edit.setOnClickListener(this);

        mHeightWheel = (WheelView) rootView.findViewById(R.id.height_wheel);
        mHeightAdapter = new NumericWheelAdapter(getContext(), HEIGHT_MIN_METRIC, HEIGHT_MAX_METRIC);
        ...
        mHeightUnitWheel = (WheelView) rootView.findViewById(R.id.height_unit_wheel);
        ...
        mHeightWheel1 = (WheelView) rootView.findViewById(R.id.height_wheel1);
        mHeightAdapter1 = new NumericWheelAdapter(getContext(), HEIGHT1_MIN_USSYSTEM, HEIGHT1_MAX_USSYSTEM);
        ...
        mHeightUnitWheel1 = (WheelView) rootView.findViewById(R.id.height_unit_wheel1);
        ...
        gender_edit = (EditText) rootView.findViewById(R.id.edit_gender);
        ...
        mGenderWheel = (WheelView) rootView.findViewById(R.id.gender_wheel);
        ...
        activity_edit = (EditText) rootView.findViewById(R.id.edit_activity_level);
        ...
        mActivityWheel = (WheelView) rootView.findViewById(R.id.activity_wheel);
        ...
        edit_daily_cal = (TextView) rootView.findViewById(R.id.edit_daily_cal);
    ...
    private void fillDatasFromPrefes() {
        ...
        if (!Utility.isBlank(preferences.getString(AppConstants.BODY_HEIGHT, ""))) {
            ...
            } else if (units_index == U_S_SYSTEM_INDEX && splitStr.length == 5) {
    ...
    private void validate_Fields() {
        ...
        try{
            if (Utility.isBlank(units_edit.getText().toString())) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_UNITS, false);
            } else if (Utility.isBlank(age_edit.getText().toString())) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_AGE, false);
            } else if (Utility.isBlank(weight_edit.getText().toString())) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_WEIGHT, false);
            } else if (Utility.isBlank(height_edit.getText().toString())) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_HEIGHT, false);
            } else if (Utility.isBlank(gender_edit.getText().toString())) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_GENDER, false);
            } else if (activity_edit.getText().toString().equals(getResources().getString(R.string.activity_level))) {
                Utility.showAlert(getActivity(), AppConstants.ENTER_ACTIVITY_LEVEL, false);
            } else {
                UserDetails mUserDetails = UserDetails.getInstance();
...
//                mUserDetails.setBody_calories(Math.round(Integer.parseInt(edit_daily_cal.getText().toString())));

                mUserDetails.setGoal_calories(Utility.calcBMI());
                mUserDetails.setPlan_calorie(String.valueOf(Calculations.calcPlanClarie(
                        Float.parseFloat(mUserDetails.getGoal_calories()))));
          ...
          /*  if (isMarkEatenPrefesAvailable(AppConstants.MARK_EATEN_STATUS)) {
                ...
                if (status) {
                    ...
                    mBuilder
                            .setMessage(
                                    getActivity().getResources().getString(R.string.alert_message_goal))
                            .setCancelable(false)
